...
(cl:defclass <TabletMsg> (roslisp-msg-protocol:ros-message)
  ((msgType
    ...
    :initform "")
   (questionNumOrPart
    :reader questionNumOrPart
    :initarg :questionNumOrPart
    :type cl:integer
    :initform 0)
   (questionType
    :reader questionType
...
(cl:ensure-generic-function 'questionNumOrPart-val :lambda-list '(m))
(cl:defmethod questionNumOrPart-val ((m <TabletMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_tutoring_behaviors-msg:questionNumOrPart-val is deprecated.  Use nao_tutoring_behaviors-msg:questionNumOrPart instead.")
  (questionNumOrPart m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <TabletMsg>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'questionNumOrPart)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 18446744073709551616) signed)))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TabletMsg>) istream)
  "Deserializes a message object of type '<TabletMsg>"
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:slot-value msg 'questionNumOrPart) (cl:if (cl:< unsigned 9223372036854775808) unsigned (cl:- unsigned 18446744073709551616))))
    (cl:let ((__ros_str_len 0))
      (cl:setf (cl:ldb (cl:byte 8 0) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TabletMsg>)))
  ...
  "91adf65652058fd1f9f3cb4c9af0c9c7")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TabletMsg)))
  "Returns md5sum for a message object of type 'TabletMsg"
  "91adf65652058fd1f9f3cb4c9af0c9c7")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TabletMsg>)))
  ...
  (cl:format cl:nil "string msgType~%int64 questionNumOrPart~%string questionType~%string robotSpeech~%string otherInfo~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TabletMsg)))
  "Returns full string definition for message of type 'TabletMsg"
  (cl:format cl:nil "string msgType~%int64 questionNumOrPart~%string questionType~%string robotSpeech~%string otherInfo~%~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <TabletMsg>))
  ...
  (cl:list 'TabletMsg
    ...
    (cl:cons ':questionNumOrPart (questionNumOrPart msg))
