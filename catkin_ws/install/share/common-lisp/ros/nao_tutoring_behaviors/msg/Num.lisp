...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nao_tutoring_behaviors-msg:<Num> is deprecated: use nao_tutoring_behaviors-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nao_tutoring_behaviors-msg:num-val is deprecated.  Use nao_tutoring_behaviors-msg:num instead.")
  (num m))
